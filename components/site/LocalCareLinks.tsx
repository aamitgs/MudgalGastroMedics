  ...
  return (
    <div className={`rounded-2xl border border-line bg-white p-6 shadow-lift md:p-8 ${className}`}>
      <div className="grid gap-6 lg:grid-cols-[0.72fr_1.28fr] lg:items-start">
        <div>
          <p className="text-xs font-black uppercase tracking-[0.18em] text-brand">Local Care Guides</p>
          ...
          <Link href="/areas" className="mt-5 inline-flex items-center gap-2 font-black text-brand">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          {pages.map((page) => (
            <Link
              ...
              className="group flex min-h-16 items-center justify-between gap-4 rounded-lg border border-line bg-soft/55 px-4 py-3 text-sm font-black text-ink transition hover:-translate-y-0.5 hover:border-brand hover:bg-white hover:text-brand"
            >
