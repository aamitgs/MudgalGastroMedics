...
const variants = {
  ...
  ghost: "border-white/55 bg-[linear-gradient(180deg,#ffffff,#f3f7f8)] text-ink shadow-[0_18px_42px_rgba(8,64,84,0.16),inset_0_1px_0_rgba(255,255,255,0.9)] hover:border-cyan-200 hover:text-brand-dark hover:shadow-[0_24px_58px_rgba(8,64,84,0.2),inset_0_1px_0_rgba(255,255,255,0.95)]"
};
