...
const moduleLoaders: Record<string, () => Promise<{ default: ComponentType }>> = {
  "module-reports": () => import("@/components/reports/AdminReports").then((m) => ({ default: m.AdminReports })),
  "module-access": () => import("@/components/access/AdminUserManagement").then((m) => ({ default: m.AdminUserManagement })),
  "module-readiness": () => import("@/components/readiness/AdminProductionReadiness").then((m) => ({ default: m.AdminProductionReadiness })),
  "module-audit": () => import("@/components/audit/AdminAuditLog").then((m) => ({ default: m.AdminAuditLog })),
  "module-analytics": () => import("@/components/analytics/AdminAnalytics").then((m) => ({ default: m.AdminAnalytics })),
  "module-cms": () => import("@/components/cms/AdminCmsWorkspace").then((m) => ({ default: m.AdminCmsWorkspace })),
  "module-modules": () => import("@/components/enterprise/AdminEnterpriseModules").then((m) => ({ default: m.AdminEnterpriseModules })),
