...
export const metadata: Metadata = {
  title: { absolute: "Comms • MudgalGastromedics OS" },
  description: "Patient communication — confirmations, reminders and messages.",
  alternates: { canonical: "/mudgalgastromedics-os/communication" },
...
export default async function CommunicationPage() {
  ...
  if (!canOpenModule(context, "module-communication")) {
    return (
      <main>
        ...
        <div className="mx-auto grid w-[min(1560px,calc(100%-32px))] place-items-center py-16">
          <div className="grid max-w-md gap-3 rounded border border-line/80 bg-white p-8 text-center shadow-sm">
            ...
            <p className="text-sm leading-relaxed text-muted">Ask a Super Admin if you need Comms access.</p>
