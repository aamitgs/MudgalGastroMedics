...
export const metadata: Metadata = {
  title: { absolute: "Patients • MudgalGastromedics OS" },
  description: "Permanent patient records and registration across the hospital.",
  alternates: { canonical: "/mudgalgastromedics-os/patients" },
...
export default async function PatientsPage() {
  ...
  if (!canOpenModule(context, "module-patients")) {
    return (
      <main>
        ...
        <div className="mx-auto grid w-[min(1560px,calc(100%-32px))] place-items-center py-16">
          <div className="grid max-w-md gap-3 rounded border border-line/80 bg-white p-8 text-center shadow-sm">
            ...
            <p className="text-sm leading-relaxed text-muted">Ask a Super Admin if you need Patients access.</p>
