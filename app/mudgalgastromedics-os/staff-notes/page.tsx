...
/** Phase 0 pilot (docs/build-roadmap.md, Track 4.13) for the Hospital OS routing migration: a dedicated route + server-side RBAC gate instead of an anchor-scrolled section on /admin. */
