...
| # | Item | Current state | Build | Pri | Effort | Depends on |
|---|---|---|---|---|---|---|
| 3.1 | **Shared enterprise DataTable** | ✅ Primitive built. ✅ **Patients**, ✅ **Appointments**, ✅ **Laboratory**, ✅ **OPD Queue**, ✅ **Pharmacy**, ✅ **IPD & Beds**, ✅ **Inventory**, ✅ **HR** adopted (`lib/*-query.ts` per module). HR is two independent DataTables on one screen (Staff Directory + Attendance), both client-paginated like IPD since the "Mark attendance" dropdown and the "Present Today" stat both need the complete unfiltered arrays regardless. Staff permissions (8 toggles) moved to a detail panel. 18 modules still card-stacks | Adopt module-by-module: next candidates are Finance, Procedures, or Communication | **High** | L | — |
